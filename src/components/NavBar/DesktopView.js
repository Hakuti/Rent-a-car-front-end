...
const navBarToLoad = ({history, styles}) => {
  let navBar;
  if(history.location.pathname === "game"){
    navBar = <DefaultContent></DefaultContent>;
    return navBar
  }else {
    navBar = <CalendarContent></CalendarContent>
    return navBar
  }
}
    ...
    <div style={{ ...styles.navBackgroundColor, ...navStyles.containerProps }}>
      ...
      {(() => {
        switch(history.location.pathname){
          case "/game": return <CalendarContent></CalendarContent>
